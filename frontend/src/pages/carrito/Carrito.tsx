...
export default function Carrito() {
  usePageTitle('Tu carrito | Tienda de Ropa');

  const navigate = useNavigate();
  const { items, actualizarCantidad: actualizarEnContexto, eliminarItem: eliminarEnContexto } = useCarrito();
  ...
  return (
    <main className={styles.paginaPrincipal}>
      <div className={styles.contenido}>
        ...
        <Link to="/productos" className={styles.continuarComprando}>
