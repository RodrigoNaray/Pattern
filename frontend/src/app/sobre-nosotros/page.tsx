...
export const metadata: Metadata = {
  ...
  description:
    'Conoce nuestra tienda de ropa en Uruguay. Como comprar, contacto, horarios y todo lo que necesitas saber.',
  openGraph: {
    title: 'Sobre nosotros | Tienda de Ropa',
    description: 'Conoce nuestra tienda de ropa en Uruguay.',
    type: 'website',
  },
};
...
export default async function SobreNosotrosPage() {
  ...
  const nombreTienda = config.nombreTienda ?? 'Tienda de Ropa';
  const whatsappNumero = config.whatsappContacto;
